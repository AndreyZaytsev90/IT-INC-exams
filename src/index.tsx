...
/*//2 return instance.get<PostType[]>('https://exams-frontend.kimitsu.it-incubator.io/api/posts') скорее всего (return instance.get<PostType[]>('posts'))
import axios from 'axios'
import React, { useEffect, useState } from 'react'
import ReactDOM from 'react-dom/client';
...
const postsAPI = {
    getPosts() {
        ...
        return instance.get<PostType[]>('https://exams-frontend.kimitsu.it-incubator.io/api/posts')
    },
}
...
//3 ( return instance.delete<{ message: string }>(`posts/${id}`))
/*
import axios from 'axios'
import React, { useEffect, useState } from 'react'
import ReactDOM from 'react-dom/client';
...
//4 return instance.post('comments', payload)
/*
import axios from 'axios'
...
//5 return instance.put<PhotoType>(`photos/${photoId}`, payload)
/*
import axios from 'axios'
import React, { useEffect, useState } from 'react'
import ReactDOM from 'react-dom/client';
...
//6 return instance.get<TodoType>(`todos/${todoId}`)
/*
import axios from 'axios'
import React, { useEffect, useState } from 'react'
import ReactDOM from 'react-dom/client';
...
//7  return instance.get(`users?pageSize=${pageNumber}&pageNumber${pageNumber}`)
/*
import axios from 'axios'
import React, { useEffect, useState } from 'react'
import ReactDOM from 'react-dom/client'
